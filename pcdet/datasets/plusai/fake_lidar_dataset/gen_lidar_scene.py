...
if __name__ == "__main__":
    bag_file = '/home/ethan/Downloads/20200926T101336_j7-e0008_0_148to152.bag'
    ...
    for topic, msg_lidar_unified, _ in bag_data_lidar_unified:
        ...
        filename = "/home/ethan/Workspace/dataset/PlusAI/blank_scene/04_%06d.txt" % frame_idx
        with open(filename, 'w') as f:
            np.savetxt(f, lidar_pts_unified)
            print("blank_scene %06d saved in %s." % (frame_idx, filename))
        frame_idx += 1
