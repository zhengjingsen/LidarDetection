...
__global__ void feature_furthest_point_sampling_kernel(int b, int n, int m, int c,
    ...
    for (int k = tid; k < n; k += stride) {
        ...
        float d = 0.0;
        for (int i = 0; i < c; ++i) {
            d += (dataset[old * c + i] - dataset[k * c + i]) * (dataset[old * c + i] - dataset[k * c + i]);
        }
...
void feature_furthest_point_sampling_kernel_launcher(int b, int n, int m, int c,
    ...
    switch (n_threads) {
        case 1024:
        feature_furthest_point_sampling_kernel<1024><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 512:
        feature_furthest_point_sampling_kernel<512><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 256:
        feature_furthest_point_sampling_kernel<256><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 128:
        feature_furthest_point_sampling_kernel<128><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 64:
        feature_furthest_point_sampling_kernel<64><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 32:
        feature_furthest_point_sampling_kernel<32><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 16:
        feature_furthest_point_sampling_kernel<16><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 8:
        feature_furthest_point_sampling_kernel<8><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 4:
        feature_furthest_point_sampling_kernel<4><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 2:
        feature_furthest_point_sampling_kernel<2><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        case 1:
        feature_furthest_point_sampling_kernel<1><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs); break;
        default:
        feature_furthest_point_sampling_kernel<512><<<b, n_threads>>>(b, n, m, c, dataset, temp, idxs);
    }
