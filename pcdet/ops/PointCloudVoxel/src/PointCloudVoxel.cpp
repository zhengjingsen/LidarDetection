...
PointCloudVoxel::PointCloudVoxel(int max_points_per_voxel,
                          ...
                          torch::Tensor bev_mapping_vf_tensor)
  {
      ...
      for(int32_t i = 0; i < point_nums; ++i)
      {
          ...
          bev_local_coordinate[point_counts][2] = points[i][2] - min_z_ - voxel_z_step_ * (bev_x_index + 0.5);
          ...
          if(bev_voxel_used[bev_voxel_index] == -1)
          {
            ...
            bev_mapping_vf[bev_voxel_counts][0] = bev_z_index;
            bev_mapping_vf[bev_voxel_counts][1] = bev_y_index;
            bev_mapping_vf[bev_voxel_counts][2] = bev_x_index;
